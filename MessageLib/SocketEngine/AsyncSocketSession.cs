...
namespace MessageLib.SocketEngine
{
    class AsyncSocketSession : SocketSession, IAsyncSocketSession
    {
        ...
        public AsyncSocketSession(int sessionID, Socket client, SocketAsyncEventArgsProxy socketAsyncProxy)
            : this(sessionID, client, socketAsyncProxy, false)
        {

        }

        public AsyncSocketSession(int sessionID, Socket client, SocketAsyncEventArgsProxy socketAsyncProxy, bool isReset)
            : base(sessionID, client)
        {
        ...
        {
            AppSession.AppServer.UpdateServerStatus(StatusInfoKeys.TotalSent, e.BytesTransferred);
        ...
        {
            AppSession.AppServer.UpdateServerStatus(StatusInfoKeys.TotalReceived, e.BytesTransferred);
            if (!ProcessCompleted(e))
            {
