...
namespace MessageLib.SocketEngine
{
        ...
        where TRequestInfo : IRequestInfo
    {
        ...
        protected override void OnNewClientAccepted(ISocketListener listener, Socket client, object state)
        {
            ...
            {
                AppServer.Logger.ErrorFormat("Process UDP package error!", e);
            }
        }

        IAppSession CreateNewSession(Socket listenSocket, IPEndPoint remoteEndPoint, int sessionID)
        {
        ...
        void ProcessPackageWithSessionID(Socket listenSocket, IPEndPoint remoteEndPoint, byte[] receivedData)
        {
            ...
            {
                AppServer.Logger.ErrorFormat("Failed to parse UDP package!", exc);
                return;
            }
        ...
        {
            var sessionID = remoteEndPoint.GetHashCode();
            var appSession = AppServer.GetSessionByID(sessionID);
        ...
        Task<ActiveConnectResult> IActiveConnector.ActiveConnect(EndPoint targetEndPoint, EndPoint localEndPoint)
        {
            ...
            var session = CreateNewSession(socket, (IPEndPoint)targetEndPoint, targetEndPoint.GetHashCode());
