...
namespace MessageLib
{
    ...
    public class WebSocket : IWebSocket
    {
        ...
        public void OnWsDisconnecting() { _wsHandler.OnWsDisconnecting(); }
        public void OnWsDisconnected() { _wsHandler.OnWsDisconnected(); }
        public void OnWsReceived(byte[] buffer, int offset, int size) { _wsHandler.OnWsReceived(buffer, offset, size); }
        public void OnWsClose(byte[] buffer, int offset, int size) { _wsHandler.OnWsClose(buffer, offset, size); }
        public void OnWsPing(byte[] buffer, int offset, int size) { _wsHandler.OnWsPing(buffer, offset, size); }
        public void OnWsPong(byte[] buffer, int offset, int size) { _wsHandler.OnWsPong(buffer, offset, size); }
        ...
        public void SendUpgrade(HttpResponse response) { _wsHandler.SendUpgrade(response); }
