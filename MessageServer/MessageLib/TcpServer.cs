...
namespace MessageLib
{
    ...
    public class TcpServer : ConnectionExtra
    {
        ...
        protected HandleResult SDK_OnError(TcpServer sender, IntPtr connId, Exception ex)
        {
            if (OnError != null)
            {
                return OnError(sender, connId, ex);
            }
