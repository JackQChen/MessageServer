...
namespace MessageLib.SocketEngine
{
    ...
    class AsyncStreamSocketSession : SocketSession, IAsyncSocketSessionBase, INegotiateSocketSession
    {
        ...
        public AsyncStreamSocketSession(int sessionID, Socket client, SslProtocols security, SocketAsyncEventArgsProxy socketAsyncProxy)
            : this(sessionID, client, security, socketAsyncProxy, false)
        {

        }

        public AsyncStreamSocketSession(int sessionID, Socket client, SslProtocols security, SocketAsyncEventArgsProxy socketAsyncProxy, bool isReset)
