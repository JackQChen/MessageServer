namespace MessageLib
{
    ...
    public class HttpSession : TcpSession
    {
        ...
        internal override void InitializeInternal(int id, TcpServer server, SocketArgs[] eventArgs)
        {
            Cache = (server as HttpServer).Cache;
            Request = new HttpRequest();
            Response = new HttpResponse();
            base.InitializeInternal(id, server, eventArgs);
        }
        ...
        public int SendResponse() { return SendResponse(Response); }
        /// <summary>
        /// Send the HTTP response (synchronous)
        /// </summary>
        /// <param name="response">HTTP response</param>
        /// <returns>Size of sent data</returns>
        public int SendResponse(HttpResponse response) { return Send(response.Cache.Data, response.Cache.Offset, response.Cache.Size); }
        ...
        /// <returns>Size of sent data</returns>
        public int SendResponseBody(string body) { return Send(body); }
        /// <summary>
        /// Send the HTTP response body (synchronous)
        /// </summary>
        /// <param name="buffer">HTTP response body buffer</param>
        /// <returns>Size of sent data</returns>
        public int SendResponseBody(byte[] buffer) { return Send(buffer); }
        /// <summary>
        /// Send the HTTP response body (synchronous)
        /// </summary>
        /// <param name="buffer">HTTP response body buffer</param>
        ...
        /// <returns>Size of sent data</returns>
        public int SendResponseBody(byte[] buffer, int offset, int size) { return Send(buffer, offset, size); }
        ...
        /// <param name="size">HTTP response body size</param>
        /// <returns>'true' if the HTTP response body was successfully sent, 'false' if the session is not connected</returns>
        public bool SendResponseBodyAsync(byte[] buffer, int offset, int size) { return SendAsync(buffer, offset, size); }
        ...
        protected override void OnReceived(byte[] buffer, int offset, int size)
        {
            ...
            {
                if (Request.ReceiveHeader(buffer, offset, size))
            ...
            if (Request.ReceiveBody(buffer, offset, size))
            {
