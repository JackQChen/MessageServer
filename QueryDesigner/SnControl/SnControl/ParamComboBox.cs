namespace SnControl
{
    ...
    public partial class ParamComboBox : ComboBox, ICommonAttribute
    {
        ...
        public ParamComboBox(IContainer container)
        {
            this.components = null;
            container.Add(this);
            this.InitializeComponent();
        ...
        public int DefaultIndex
        {
            get
            {
                return this.FDefaultIndex;
            }
            set
            {
                this.FDefaultIndex = value;
            }
        }
    }
}
