...
namespace MessageLib
{
    ...
    public class HttpRequest
    {
        ...
        /// </summary>
        public int Headers { get { return _headers.Count; } }
        /// <summary>
        ...
        /// </summary>
        public int Cookies { get { return _cookies.Count; } }
        /// <summary>
        ...
        /// </summary>
        public int BodyLength { get { return _bodyLength; } }
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine(string.Format("Request method: {0}", Method));
            sb.AppendLine(string.Format("Request URL: {0}", Url));
            sb.AppendLine(string.Format("Request protocol: {0}", Protocol));
            sb.AppendLine(string.Format("Request headers: {0}", Headers));
            for (int i = 0; i < Headers; i++)
            {
                var header = Header(i);
                sb.AppendLine(string.Format("{0} : {1}", header.Item1, header.Item2));
            }
            sb.AppendLine(string.Format("Request body: {0}", BodyLength));
            sb.AppendLine(Body);
            return sb.ToString();
        }
        ...
        internal bool ReceiveHeader(byte[] buffer, int offset, int size)
        {
            ...
            for (int i = _cacheSize; i < _cache.Size; i++)
            {
            ...
            // Update the parsed cache size
            _cacheSize = (_cache.Size >= 3) ? (_cache.Size - 3) : 0;
