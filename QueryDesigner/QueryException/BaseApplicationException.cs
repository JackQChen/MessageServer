...
namespace QueryException
{
	...
	public class BaseApplicationException : ApplicationException
	{
		...
		{									
			...
			{
				machineName = ExceptionConst.RES_EXCEPTIONMANAGEMENT_PERMISSION_DENIED;
				
			}
			catch
			{
				machineName = ExceptionConst.RES_EXCEPTIONMANAGEMENT_INFOACCESS_EXCEPTION;
			}
			...
			{
				threadIdentity = ExceptionConst.RES_EXCEPTIONMANAGEMENT_PERMISSION_DENIED;
			}
			catch
			{
				threadIdentity = ExceptionConst.RES_EXCEPTIONMANAGEMENT_INFOACCESS_EXCEPTION;
			}			
			...
			{
				windowsIdentity = ExceptionConst.RES_EXCEPTIONMANAGEMENT_PERMISSION_DENIED;
			}
			catch
			{
				windowsIdentity = ExceptionConst.RES_EXCEPTIONMANAGEMENT_INFOACCESS_EXCEPTION;
			}
			...
			{
				appDomainName = ExceptionConst.RES_EXCEPTIONMANAGEMENT_PERMISSION_DENIED;
			}
			catch
			{
				appDomainName = ExceptionConst.RES_EXCEPTIONMANAGEMENT_INFOACCESS_EXCEPTION;
			}			
		}
	}	
}