...
namespace MessageLib
{
    public interface IWebSocket
    {
        ...
        void OnWsReceived(byte[] buffer, int offset, int size);
        ...
        /// <param name="offset">Received buffer offset</param>
        /// <param name="size">Received buffer size</param>
        void OnWsClose(byte[] buffer, int offset, int size);
        ...
        /// <param name="offset">Received buffer offset</param>
        /// <param name="size">Received buffer size</param>
        void OnWsPing(byte[] buffer, int offset, int size);
        ...
        /// <param name="offset">Received buffer offset</param>
        /// <param name="size">Received buffer size</param>
        void OnWsPong(byte[] buffer, int offset, int size);
